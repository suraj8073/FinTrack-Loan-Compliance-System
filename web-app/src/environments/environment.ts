...
export const environment = {
  ...
  allowServerSwitch: false, // Disable server switching to force local connection
  apiProvider: '/fineract-provider/api',
  apiVersion: '/v1',
  serverUrl: '',
  oauth: {
    enabled: false, // Keep OAuth disabled for local development
    serverUrl: '',
    appId: ''
  },
  warningDialog: {
    title: 'Warning',
    content:
      'Welcome to FinTrack, This system is for authorized use only. Unauthorized access will result in possible legal action. By accessing this system, you acknowledge that you are authorized to do so and that all data stored and processed here is confidential.',
    buttonText: 'Close'
  },
